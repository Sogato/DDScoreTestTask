...
**Status** - статус операции (Бизнес, Личное, Налоги и т.д.)
...
**Category** - категория операции (связана с типом)
- name: название категории
- slug: уникальный идентификатор
- type: внешний ключ на Type

**Subcategory** - подкатегория операции (связана с категорией)
- name: название подкатегории
- slug: уникальный идентификатор
- category: внешний ключ на Category

**Transaction** - транзакция (основная сущность)
- date: дата операции (автозаполнение текущей датой)
- status: внешний ключ на Status (защищен от удаления)
- type: внешний ключ на Type (защищен от удаления)
- category: внешний ключ на Category (защищен от удаления)
- subcategory: внешний ключ на Subcategory (защищен от удаления)
- amount: сумма операции (Decimal, 15 знаков, 2 знака после запятой)
